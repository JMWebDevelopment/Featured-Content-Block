<?php
/**
 * The Featured Content - Row with Right Photo and Reverse Background pattern.
 *
 * @since 1.0
 *
 * @version 1.0
...
register_block_pattern(
	'featured-content-block-patterns/featured-content-block-reverse-row-photo-right',
	array(
		'title'         => esc_html__( 'Featured Content - Row with Right Photo and Reverse Background', 'featured-content-block' ),
		'viewportWidth' => 1200,
